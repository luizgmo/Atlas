...
function loadDataTable(){
    dataTable = $('#tblData').DataTable({
        ...
        "columns": [
            { "data" : "name", "width": "40%" },
            { "data" : "price", "width": "30%", "render": $.fn.dataTable.render.number('.', ',', 2) },
            { "data" : "id", "width": "30%", "bSortable": false,
                "render": function(data) {
                    return `
                        <div class="text-xs text-secondary mb-0">
                            <a href="/Value/Edit?id=${data}" title="Editar">
                                <span class="material-icons">edit</span>
                            </a> &nbsp &nbsp
                            <a href="/Value/Details?id=${data}" title="Detalhes">
                                <span class="material-icons">info</span>
                            </a> &nbsp &nbsp
                            <a href="javascript:void(0)" onclick="Delete('/Value/Delete?id=${data}')" title="Excluir">
