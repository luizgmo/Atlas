                ...
                "render": function (data) {
                    return `
                        <div class="text-xs text-secondary mb-0">
                            <a href="/Coach/Edit?id=${data}" title="Editar">
                                <span class="material-icons">edit</span>
                            </a> &nbsp &nbsp
                            <a href="/Coach/Details?id=${data}" title="Detalhes">
                                <span class="material-icons">info</span>
                            </a> &nbsp &nbsp
                            <a href="javascript:void(0)" onclick="Delete('/Coach/Delete?id=${data}')" title="Excluir">
